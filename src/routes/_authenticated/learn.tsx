      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        {data.length === 0 ? (
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {data.map((e) => e.course && (
              <Link key={e.course.id} to="/learn/$slug" params={{ slug: e.course.slug }} search={{ lesson: undefined }} className="group block rounded-3xl bg-card p-6 transition hover:-translate-y-1">
