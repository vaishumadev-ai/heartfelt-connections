            ...
            <div className="rounded-3xl bg-card p-6">
              ...
              {userId ? (
                <button
                  ...
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-[#ff5a6a] px-6 py-3 text-sm font-semibold text-background/30 transition hover:brightness-110 disabled:opacity-60"
                >
